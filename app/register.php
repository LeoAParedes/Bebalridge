...
if(isset($_POST['submit'])){
    ...
    if ($checkuser->rowCount() > 0) {
        ...
        $insertQuery = $pdo->prepare("INSERT INTO users (username, password, created_at) VALUES (:username, :password, NOW())");
        ...
        if ($insertQuery->execute()) {
            ...
            echo "Error: " . implode(", ", $insertQuery->errorInfo()); // Display error message
        }
    }
